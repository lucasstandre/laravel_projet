...
@section('title', 'Ajouter un album')
...
<div style="background: linear-gradient(105deg, #01060f 0%, #03152d 52%, #04142b 100%); min-height: 100vh; padding: 2rem; color: #dbe7ff;">
    <div style="max-width: 700px; margin: 0 auto;">
        <h1 style="margin: 0 0 1rem;">Ajouter un album</h1>
        ...
        <form method="POST" action="{{ route('albums.store') }}" style="display: grid; gap: 0.8rem;">
            @csrf
            ...
            <input type="text" name="photo" placeholder="Photo" style="padding: 0.75rem; border-radius: 8px; border: 1px solid rgba(126, 162, 211, 0.3); background: rgba(28, 50, 84, 0.7); color: #f1f7ff;">
            ...
            <div style="display: flex; gap: 0.7rem; margin-top: 0.5rem;">
                ...
                <a href="{{ route('albums.store') }}" style="padding: 0.7rem 1rem; border-radius: 8px; border: 1px solid rgba(126, 162, 211, 0.4); color: #dbe7ff; text-decoration: none;">Annuler</a>
            </div>
        </form>
    </div>
</div>
